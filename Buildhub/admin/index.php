            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-6">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo h(peso($stats['total_revenue'])); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-medium text-gray-500">Products Listed</h3>
                            <p class="text-2xl font-bold text-gray-900"><?php echo h($stats['products_listed']); ?></p>
                        </div>
                    </div>
                </div>
            </div>
