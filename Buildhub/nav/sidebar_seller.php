<aside class="bg-white border-r border-gray-200 w-16 md:w-64 flex flex-col transition-all duration-300 fixed top-0 left-0 h-screen z-[20] overflow-y-auto">
  ...
  <nav class="flex-1 p-2 md:p-4 space-y-1 md:space-y-2 mt-4">
    <a href="../admin/index.php" class="sidebar-item w-full flex items-center space-x-3 px-3 py-2 rounded-xl text-gray-700 hover:bg-gray-100 transition-all duration-200 font-medium active:bg-yellow-100 active:text-yellow-700">
      ...
      <a href="../admin/orders.php" class="sidebar-item w-full flex items-center space-x-3 px-3 py-2 rounded-xl text-gray-700 hover:bg-gray-100 transition-all duration-200 font-medium active:bg-yellow-100 active:text-yellow-700">
        <svg class="heroicon w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
        </svg>
        <span class="sidebar-label hidden md:inline">Listing</span>
      </a>

    <!-- ✅ My Orders (restored) -->
    <a href="../admin/myorders.php" class="sidebar-item w-full flex items-center space-x-3 px-3 py-2 rounded-xl text-gray-700 hover:bg-gray-100 transition-all duration-200 font-medium active:bg-yellow-100 active:text-yellow-700">
        <svg class="heroicon w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="../admin/settings.php" class="sidebar-item w-full flex items-center space-x-3 px-3 py-2 rounded-xl text-gray-700 hover:bg-gray-100 transition-all duration-200 font-medium active:bg-yellow-100 active:text-yellow-700">
      <svg class="heroicon w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
